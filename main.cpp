...
void drawGoals()
{
	for (int i = 0; i < goals.size(); ++i) {
		...
		/*
		glPushMatrix();
		Rectangular Rectangular(20,10,10);
		Rectangular.setPosition(20, 0, 10);
		Rectangular.setRotation(0);
		Rectangular.positionInGL();
		Rectangular.setColor(0, 0, 1);
		Rectangular.setColorInGL();
		Rectangular.draw();
		glPopMatrix();

		glPushMatrix();
		Triangle Triangle(20, 20, 30, 10);
		Triangle.setPosition(-10, 0, 10);
		Triangle.setRotation(0);
		Triangle.positionInGL();
		...
		glPushMatrix();
		Trapezoidal Trapezoidal(20,10,7,10,10);
		Trapezoidal.setPosition(-20, 5, -5);
		Trapezoidal.setRotation(0);
		Trapezoidal.positionInGL();
		Trapezoidal.setColor(0, 0, 1);
		Trapezoidal.setColorInGL();
		Trapezoidal.draw();
		glPopMatrix();
		*/
		glPushMatrix();
		Cylinder Cylinder(20,20,false,false);
		Cylinder.setPosition(10, 5, -5);
		Cylinder.setRotation(0);
		Cylinder.positionInGL();
		Cylinder.setColor(0, 1, 1);
		Cylinder.setColorInGL();
		Cylinder.draw();
		glPopMatrix();
